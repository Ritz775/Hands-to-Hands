...
classifier = ml5.imageClassifier(
  "https://teachablemachine.withgoogle.com/models/Zy0Gg7lFi/model.json",
  modelLoaded
);
...
function got_result(error, results) {
  if (error) {
    ...
    if (results[0].label == "shake hands") {
      document.getElementById("update_emoji").innerHTML = "&#129309";
    }
    ...
    if (results[1].label == "shake hands") {
      document.getElementById("update_emoji2").innerHTML = "&#129309";
    }
  }
}
